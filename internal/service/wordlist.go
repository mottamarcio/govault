...
// DefaultWordlist contains a curated subset of standardized EFF Diceware words for generating memorable passphrases.
var DefaultWordlist = []string{
	"abacus", "abdomen", "ability", "abnormal", "above", "absence", "absolute", "absorb",
	"abstract", "absurd", "accent", "accept", "access", "accident", "account", "accurate",
	"achieve", "acid", "acoustic", "acquire", "across", "action", "active", "actor",
	"actress", "actual", "adapt", "add", "addict", "address", "adjust", "admit",
	"adult", "advance", "advice", "aerobic", "affair", "afford", "afraid", "again",
	"agent", "agree", "ahead", "aim", "airport", "aisle", "alarm", "album",
	...
	"indoor", "industry", "infant", "inflict", "inform", "initial", "inject", "injury",
	...
	"seat", "second", "secret", "section", "security", "seduce", "see", "seed",
